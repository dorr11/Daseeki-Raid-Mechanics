...
local function EnsureFrame()
    ...
    c.header:SetPoint("TOPLEFT", c, "TOPLEFT", 6, -4); c.header:SetText("|cff66ccffGothik Waves|r")
    ...
    Addon:StyleFont(c.wave); Addon:StyleFont(c.next, Addon.Theme.subText); Addon:StyleFont(c.phase2, Addon.Theme.subText)
